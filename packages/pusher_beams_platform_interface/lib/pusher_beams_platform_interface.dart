...
typedef OnNotificationTapped = Function(Map<Object?, Object?> data); 
...
abstract class PusherBeamsPlatform extends PlatformInterface {
  ...
  Future<void> onNotificationTapped(OnNotificationTapped callback) {
    throw UnimplementedError('onNotificationTapped() has not been implemented.');
  }
}
