...
- (void)getInitialMessageWithCompletion:(void (^)(NSDictionary<NSString *, dynamic *> *_Nullable, FlutterError *_Nullable))completion;
...
- (void)handleCallbackCallbackId:(NSString *)callbackId callbackName:(NSString *)callbackName args:(NSArray *)args completion:(void (^)(FlutterError *_Nullable))completion;
@end
